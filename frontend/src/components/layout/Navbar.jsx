...
{user && (
  <button
    ...
    className="flex items-center gap-3 px-2 py-1 rounded-lg hover:bg-gray-100 transition text-gray-700"
  >
    <Heart size={20} />
...
{user ? (
  <button
    ...
    className="flex items-center gap-2 text-red-500 hover:bg-red-50 px-3 py-1.5 rounded-lg transition"
  >
    ↩ Logout
  </button>
) : (
      ...
      {user ? (
        <div className="flex flex-col gap-3 mt-3">
          ...
          {user?.role === "admin" && (
            <button
              onClick={() => navigate("/admin")}
              className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition text-blue-600 font-medium"
            >
              ⚙ Admin
            </button>
          )}
          ...
          <button
            onClick={handleLogout}
            className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-red-50 text-red-500 transition"
          >
            ↩ Logout
          </button>
